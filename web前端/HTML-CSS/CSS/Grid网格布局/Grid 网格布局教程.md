...
description: 网格布局（Grid）是最强大的 CSS 布局方案。
keywords: 开发者手册
author: 作者： 阮一峰
date: 2019-03-25T04:00:00.000Z
publisher: null
stats: paragraph=356 sentences=94, words=904
---
...
注意：项目只能是容器的顶层子元素，不包含项目的子元素，比如上面代码的 `<p></p>`元素就不是项目。Grid 布局只对项目生效。
