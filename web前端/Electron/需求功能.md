...
window.globalBasicAPI
  ?.getLocalIP?.()
  .then((a) => {
    console.log("then::>res", a);
    b = a;
  })
  .catch((e) => {
...
// b
// ['192.168.22.24','172.20.6.150',172.21.0.150','172.30.0.150','192.168.56.1']
